...
def callback(data):
    ...
    if _initState == 0:
        _initState = 1
        _prevT = data.header.stamp.nsecs / 1000.0

    else:
        dt = data.header.stamp.nsecs / 1000.0 - _prevT
        _prevT = data.header.stamp.nsecs / 1000.0
        ...
        msg = Imu()
        msg.orientation.w = q_GL[0]
        msg.orientation.x = q_GL[1]
        msg.orientation.y = q_GL[2]
        msg.orientation.z = q_GL[3]
